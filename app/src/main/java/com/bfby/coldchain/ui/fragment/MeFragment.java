...
import com.bfby.coldchain.common.widget.item_view;
import com.bfby.coldchain.ui.activity.AboutActivity;
import com.bfby.coldchain.ui.activity.EquipmentNewInfoActivity;
import com.bfby.coldchain.ui.activity.HelpFeedbackActivity;
import com.bfby.coldchain.ui.activity.MyDataActivity;
import com.bfby.coldchain.ui.activity.SettingActivity;
...
public class MeFragment extends BaseLazyFragment {
    ...
    Unbinder unbinder;
    @BindView(R.id.item_view_mydriver)
    item_view mItemViewMydriver;
    Unbinder unbinder1;
    ...
    @OnClick({R.id.mydata_relative, R.id.item_view_aboutme, R.id.item_view_feedback, R.id.item_view_install, R.id.item_view_mydriver})

    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.item_view_mydriver:
                getContext().startActivity(new Intent(getContext(), EquipmentNewInfoActivity.class));
                break;
