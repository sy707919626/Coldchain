package com.bfby.coldchain.ui.base;
...
import com.bfby.coldchain.Bean.SaleEntity;
import com.bfby.coldchain.MyApplication;
import com.bfby.coldchain.R;
import com.bfby.coldchain.common.util.PermissionsChecker;
import com.bfby.coldchain.data.http.ApiService;
import com.bfby.coldchain.ui.adapter.MyAdapter;
...
public abstract class BaseActivity extends RxAppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mApi = mApplication.getApi();
        mApiS = mApplication.getApiS();
