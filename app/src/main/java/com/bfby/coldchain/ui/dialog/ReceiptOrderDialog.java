package com.bfby.coldchain.ui.dialog;
...
//                .compose(RxHttpResponseCompatTest.<EquipmentFeeBean>compatResult())
//                .subscribe(new ErrorHandlerSubscriber<EquipmentFeeBean>() {
//                    @Override
//                    public void onNext(EquipmentFeeBean equipmentFeeBean) {
